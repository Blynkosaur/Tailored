...
def compile_latex_with_logo(latex_content: str, logo_bytes: bytes | None = None) -> bytes:
    """
...
async def generate_cover_letter(
    ...
    if job_url and job_description:
        raise HTTPException(status_code=400, detail="Provide only one of job_url or job_description")
